...
```
![img link missing values](https://github.com/TSLSouth/Churn-Prediction/blob/main/img/missing%20valuest.png?raw=true)
...
![img link fillna values](https://github.com/TSLSouth/Churn-Prediction/blob/main/img/fillna.png?raw=true)
...
![img link status vs churn](https://github.com/TSLSouth/Churn-Prediction/blob/main/img/status_vs_churn.png?raw=true)

<br>

How 'Plan Type' is correlated with 'Churn'. We can see that 'Freemium' and 'Paid' users has the same churn:

![img link plan type vs churn](https://github.com/TSLSouth/Churn-Prediction/blob/main/img/plan_type_vs_churn.png?raw=true)

<br>

Counting evasions(churn) of active users. We can see that is a unbalenced data set::

![img link active users churn](https://github.com/TSLSouth/Churn-Prediction/blob/main/img/active_users_churn.png?raw=true)
...
![img link heatmap correlations values](https://github.com/TSLSouth/Churn-Prediction/blob/main/img/heatmap_corr.png?raw=true)

<br>

Counting Status_PRESENT without outliers (how many sessions each user took):

![img link attendance by user](https://github.com/TSLSouth/Churn-Prediction/blob/main/img/attendance_by_user.png?raw=true)

<br>

Churn by instructor:

![img link churn by instructor](https://github.com/TSLSouth/Churn-Prediction/blob/main/img/churn_by_instructor.png?raw=true)

<br>

Avg. monthly attendance (Paid Users):

![img link monthly attendance](https://github.com/TSLSouth/Churn-Prediction/blob/main/img/monthly_attendance.png?raw=true)

<br>

Avg. attendance by churn (Paid Users):

![img link avg attendance by churn](https://github.com/TSLSouth/Churn-Prediction/blob/main/img/avg_attendance_by_churn.png?raw=true)
...
![img link unbalanced data](https://github.com/TSLSouth/Churn-Prediction/blob/main/img/unbalanced_data.png?raw=true)
...
![img link balanced data](https://github.com/TSLSouth/Churn-Prediction/blob/main/img/balanced_data.png?raw=true)
